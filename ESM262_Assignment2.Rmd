...
dbGetQuery(con, "SELECT COUNT(FEATURE_NAME), FEATURE_NAME 
           FROM gaz 
...
dbGetQuery(con, "SELECT COUNT(FEATURE_CLASS), FEATURE_CLASS 
           FROM gaz 
...
dbGetQuery(con, "SELECT COUNTY_NAME, avg(PRIM_LAT_DEC), avg(PRIM_LONG_DEC) 
           FROM gaz 
